...
class BannerController extends Controller
{
    ...
    {
        $banner_category = BannerCategory::orderBy('id','DESC')->select('id','name')->get();
        return view('backEnd.banner.create',compact('banner_category'));
    }
    ...
    public function edit($id)
    {
        ...
        $banner_category = BannerCategory::select('id','name')->get();
        return view('backEnd.banner.edit',compact('edit_data','banner_category'));
    }
