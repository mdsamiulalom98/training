                ...
                <form action="{{route('services.store')}}" method="POST" class="row" data-parsley-validate=""  enctype="multipart/form-data">
                    ...
                    <div class="col-sm-12">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control @error('meta_title') is-invalid @enderror" name="meta_title" value="{{ old('meta_title') }}" id="meta_title" required="">
                            @error('meta_title')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="col-sm-12">
                        <div class="form-group mb-3">
                            ...
                            <textarea type="text" class="form-control @error('meta_description') is-invalid @enderror" name="meta_description" rows="6" value="{{ old('meta_description') }}"  id="meta_description"></textarea>
                    ...
                    <div class="col-sm-12">
                        <div class="form-group mb-3">
                            ...
                            <textarea type="text" class="form-control @error('meta_keyword') is-invalid @enderror" name="meta_keyword" rows="6" value="{{ old('meta_keyword') }}"  id="meta_keyword"></textarea>
                            @error('meta_keyword')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
