                        ...
                        <!-- col end -->
                            <div class="col-sm-6 mb-3">
                                <div class="form-group">
                                    ...
                                    name="slider_title" value="{{ $edit_data->slider_title }}" id="slider_title">
                                    @error('slider_title')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-sm-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('slider_details') is-invalid @enderror"
                                    name="slider_details" value="{{ $edit_data->slider_details }}" id="slider_details">
                            ...
                            <div class="col-sm-12 mb-3">
                                <div class="form-group">
                                    <label for="footer_details" class="form-label">Footer Details</label>
                                    <input type="text" class="form-control @error('footer_details') is-invalid @enderror"
                                    name="footer_details" value="{{ $edit_data->footer_details }}" id="footer_details">
