    ...
    <div class="container-fluid">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('courses.store') }}" method="POST" class="row" data-parsley-validate=""
                            ...
                            <div class="col-sm-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('lecture') is-invalid @enderror"
                                        name="lecture" value="{{ old('lecture') }}" id="lecture" required>
                                    @error('lecture')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('schedule') is-invalid @enderror"
                                        name="schedule" value="{{ old('schedule') }}" id="schedule" required>
                                    @error('schedule')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group mb-3">
                                    ...
                                    <textarea class="form-control @error('module') is-invalid @enderror" name="module" id="module" required>{{ old('module') }}</textarea>
                                    @error('module')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('meta_title') is-invalid @enderror"
                                        name="meta_title" value="{{ old('meta_title') }}" id="meta_title" required>
                                    @error('meta_title')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                    ...
                                    <div class="col-sm-5">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text"
                                                ...
                                                name="feature_name[]" value="{{ old('feature_name[]') }}"
                                                id="feature_name[]">
                                            @error('feature_name')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
